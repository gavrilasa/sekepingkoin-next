...
import { CryptoCurrency, FiatCurrency, ConversionResult, ConversionType } from "@/types";
...
export function ConverterCard({ cryptocurrencies, fiatCurrencies }: ConverterCardProps) {
  const [conversionType, setConversionType] = useState<ConversionType>("crypto-to-fiat");
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto shadow-lg border-0 bg-gradient-to-br from-card to-card/90">
        ...
        >
          ...
          <div className="space-y-6">
            <AmountInput 
              ...
              currencySymbol={
                conversionType === "crypto-to-fiat"
                  ? cryptocurrencies.find(c => c.symbol === sourceCurrency)?.symbol || ""
                  : fiatCurrencies.find(c => c.id === sourceCurrency)?.symbol || ""
              }
              label={`Amount in ${
                conversionType === "crypto-to-fiat" 
                  ? cryptocurrencies.find(c => c.symbol === sourceCurrency)?.name 
            ...
            <div className="grid grid-cols-[1fr,auto,1fr] items-center gap-3">
              <CurrencySelector
                currencies={conversionType === "crypto-to-fiat" ? cryptocurrencies : fiatCurrencies}
              ...
              <Button
                ...
                className="h-10 w-10 rounded-full bg-muted/50 hover:bg-muted transition-all duration-200"
              >
              ...
              <CurrencySelector
                currencies={conversionType === "crypto-to-fiat" ? fiatCurrencies : cryptocurrencies}
